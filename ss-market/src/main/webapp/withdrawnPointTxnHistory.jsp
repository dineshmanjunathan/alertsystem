						...
						<div class="product-payment-inner-st">
							<ul id="myTabedu1" class="tab-review-design">
								<div class="text-center">
									<li class="active">
									<a href="">Withdrawn Point Transaction History</a>
									</li>
								</div>
							</ul>
							...
							<div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div id="toolbar">
                                     ...
                                     <table id="withdrawnPointsHistoryListTable" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                     ...
                                     <thead>
										<tr> 
											...
											<th data-field="txnDate" data-editable="false">Withdrawn Date</th>
