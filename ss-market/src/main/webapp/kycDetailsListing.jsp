		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="product-payment-inner-st">
				<ul id="myTabedu1" class="tab-review-design">
					<center>
						<li class="active"><a href="">Validate and approve Pan
								card Number</a></li>
					</center>
				</ul>
							...
							<div class="sparkline13-graph">
								<div class="datatable-dashv1-list custom-datatable-overright">
									...
									<table id="table" data-toggle="table" data-pagination="true"
										...
										<thead>
											<tr>
												<th data-field="memberid" data-editable="false">Pan
													Number</th>
												<th data-field="orderNumber" data-editable="false">Pan
													Image</th>
												<th data-field="action">Action</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach var="details" items="${kycDetails}"
												varStatus="status">
												<tr>
													<td>${kycDetails.pancardNumber}</td>
													<td><img alt="img"
														src="data:image/jpeg;base64,${kycDetails.base64Image}"
														style="width: 100px; height: 100px;" /></td>

													<c:choose>
														<c:when test="${details.orderStatus == 'PENDING'}">
															<td><a
																href="<c:url value='/purchase/approve?id=${details.id}' />">
